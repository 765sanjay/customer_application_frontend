...
class ShopInfoCard extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _buildInfoRow(Icons.people, '$followers Followers', iconSize, textSize),
              _buildInfoRow(Icons.star, '$popularity Popularity', iconSize, textSize),
            ],
          ),
          SizedBox(height: 16),
          ...
          Row(
            ...
            children: [
              _buildCircularButton(Icons.person_add, "Follow", iconSize, textSize),
              _buildCircularButton(Icons.thumb_up, "$likesCount", iconSize, textSize),
              _buildCircularButton(Icons.star_border, "Rate", iconSize, textSize),
            ],
          ),
          SizedBox(height: 16),
  ...
  Widget _buildInfoRow(IconData icon, String label, double iconSize, double textSize) {
    return Row(
      children: [
  ...
  Widget _buildCircularButton(IconData icon, String label, double iconSize, double textSize) {
    return Column(
      children: [
        Container(
